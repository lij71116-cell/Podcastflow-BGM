...
class PodcastSource(Base):
    ...
    __table_args__ = (Index("ix_podcast_sources_session_id", "session_id"),)
...
class BgmSource(Base):
    ...
    __table_args__ = (Index("ix_bgm_sources_session_id", "session_id"),)
...
class MixedAudioAsset(Base):
    ...
    __table_args__ = (Index("ix_mixed_audio_assets_session_id", "session_id"),)
